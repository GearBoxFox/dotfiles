...
local image = wibox.widget {
	image = os.getenv("HOME") .. '/.config/awesome/popups/osds/assets/volume2.png',
...
local volume_text = wibox.widget {
	markup = '<span color="' .. x.color11 .. '" font="Ubuntu Nerd Font bold 12">' .. 'Volume' .. '</span>'
	,
...
local volume_percentage = wibox.widget {
	markup = '<span color="' ..
		x.color11 .. '" font="Ubuntu Nerd Font bold 12">' .. volume_slider.value .. '</span>'
	,
	widget = wibox.widget.textbox,
	fg = x.color11,
}
...
local update_volume_slider = function()
	awful.spawn.easy_async("amixer sget Master", function(stdout)
		...
		volume_percentage.markup = '<span color="' ..
			x.color11 .. '" font="Ubuntu Nerd Font bold 12">' .. volume .. '</span>'
	end)
end
